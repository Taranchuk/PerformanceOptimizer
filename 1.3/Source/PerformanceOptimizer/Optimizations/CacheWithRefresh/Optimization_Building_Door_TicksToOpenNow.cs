...
namespace PerformanceOptimizer
{
    ...
    public class Optimization_Building_Door_TicksToOpenNow : Optimization_RefreshRate
    {
        ...
        public static Dictionary<int, CachedValueTick<int>> cachedResults = new Dictionary<int, CachedValueTick<int>>();
        ...
        public static bool Prefix(Building_Door __instance, out CachedValueTick<int> __state, ref int __result)
        {
            ...
            {
                cachedResults[__instance.thingIDNumber] = __state = new CachedValueTick<int>();
                return true;
            }
