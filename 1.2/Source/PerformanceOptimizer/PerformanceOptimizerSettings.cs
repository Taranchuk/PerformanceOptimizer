...
namespace PerformanceOptimizer
{
    ...
    public class PerformanceOptimizerSettings : ModSettings
    {
        ...
        public void DoSettingsWindowContents(Rect inRect)
        {
            ...
            var uiSection = topLeftSection.BeginSection_NewTemp(sectionHeightSize, 10, 10);
            ...
            var miscSettings = miscSettingsSection.BeginSection_NewTemp(sectionHeightSize, 10, 10);
            ...
            var cacheSettings = cacheSection.BeginSection_NewTemp(cacheSettingsHeight - 20, 10, 10);
