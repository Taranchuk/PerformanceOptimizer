...
{
    public class Optimization_CompOverseerSubject_CanGoFeral : Optimization_RefreshRate
    {
        ...
        public override string Label => "PO.CanGoFeral".Translate();
        public override void DoPatches()
        {
            base.DoPatches();
            Patch(typeof(CompOverseerSubject), "CanGoFeral", GetMethod(nameof(Prefix)), GetMethod(nameof(Postfix)));
        }
